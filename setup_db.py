...
def init_db():
    ...
    test_users = [
        ...
        (9, 'David Kim', 'producer', 'david@test.com', 'Hip hop producer looking for vocalists', 'DAW, Production, Mix', 'Atlanta, GA', 'https://images.unsplash.com/photo-1500648767791-00d2bce98a3f?w=200&h=200&fit=crop', 'Hip Hop, R&B, Trap', None),
        (10, 'Luna Vega', 'musician', 'luna@test.com', 'Classical crossover violinist', 'Violin, Piano', 'Boston, MA', 'https://images.unsplash.com/photo-1515934751633-a2fcab0cb2e4?w=200&h=200&fit=crop', 'Classical, Neo-Classical, Electronic', None),
    ]
